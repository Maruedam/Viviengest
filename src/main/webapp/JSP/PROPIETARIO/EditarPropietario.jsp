<%-- 
    ...
    Created on : 23-nov-2020, 9:43:00
    Author     : dwigh
--%>
...
<html>
    ...
    <body>
                            ...
                            <form class="form"  method="post" id="formulario">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="password" maxlength="30"  class="form-control" name="passwd" id="passwd" value="${sessionScope.usuario.getPasswd()}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <label for="numecuenta"><h4>N&uacute;mero de cuenta</h4></label>
                                        <input type="text"  maxlength="30" class="form-control" name="numecuenta" id="numecuenta"  value="${sessionScope.propietario.getNumecuenta()}">
                                    </div>
                                    <div class="col-xs-6">
                                        <label for="direccionpostal"><h4>Direcci&oacute;n postal</h4></label>
                                        <input type="text" maxlength="30"  class="form-control" name="direccionpostal" id="direccionpostal" value="${sessionScope.propietario.getDireccionpostal()}" >
                                    </div>
                                </div>
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/JS/ModificarPJs.js"></script>  
    </body>
</html>
